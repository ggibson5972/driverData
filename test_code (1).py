...
#GIVEN INPUT
inFile= open("C:\Users\grace\Desktop\input1.txt","r")
outFile = open("C:\Users\grace\Desktop\output1.txt", "w")
contents = inFile.read()
inFile.close()
drivers = separate(contents)
output_list = createOutputAndSort(drivers)
toFile (output_list, outFile)
outFile.close()
...
#STAR WARS INPUT
inFile= open("C:\Users\grace\Desktop\input2.txt","r")
outFile = open("C:\Users\grace\Desktop\output2.txt", "w")
contents = inFile.read()
inFile.close()
drivers = separate(contents)
output_list = createOutputAndSort(drivers)
...
#LORD OF THE RINGS INPUT
inFile= open("C:\Users\grace\Desktop\input3.txt","r")
outFile = open("C:\Users\grace\Desktop\output3.txt", "w")
contents = inFile.read()
inFile.close()
drivers = separate(contents)
output_list = createOutputAndSort(drivers)
